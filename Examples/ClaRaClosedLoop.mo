...
model Regression
  ...
  StaticCycles.Check.StaticCycleExamples.InitSteamCycle_T_4_Pr_F1_C1_version2 INIT(
    P_target_=1,
  ...
  StaticCycles.Check.StaticCycleExamples.InitSteamCycle_T_4_Pr_F1_C1_version2 NOM(
    final P_target_=1,
