...
//___________________________________________________________________________//
  ...
  final parameter ClaRa.Basics.Units.MassFlowRate m_flow_1(fixed=false, start=1) "|Internals|Internally set values - do not edit!|Mass flow rate of flow 1";
  final parameter ClaRa.Basics.Units.MassFlowRate m_flow_2(fixed=false, start=1) "|Internals|Internally set values - do not edit!|Mass flow rate of flow 2";
  ...
  Fundamentals.SteamSignal_blue outlet(h=h3, m_flow=m_flow_3) annotation (
      Placement(transformation(extent={{40,10},{50,30}}), iconTransformation(extent={{40,10},{50,30}})));
initial equation
  inlet_1.h=h1;
...
equation
  connect(inlet_1, inlet_1) annotation (Line(
      points={{-45,20},{-45,11},{-45,11},{-45,20}},
      color={0,131,169},
      smooth=Smooth.None));
