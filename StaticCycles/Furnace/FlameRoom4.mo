...
model FlameRoom4 "Fixed fluid outlet temperature | blue | blue || brown | brown"
...
//  parameter ClaRa.Basics.Units.MassFlowRate m_flow_nom "Nominal mass flow" annotation(Dialog(group="Nominal Operation Point"));
  ...
  parameter Real CharLine_h_wall_P_target_[:,2]=[0,1;1,1] "Characteristic line of h_vle_walls_out as function of P_target_" annotation(Dialog(group="Part Load Definition"));
...
// _________GENERAL VALUES ___________
  ...
  final parameter ClaRa.Basics.Units.Pressure p_vle_bundle_in = p_vle_bundle_out + Delta_p_vle_bundle+Delta_p_geo_wall " VLE medium's inlet pressure";
