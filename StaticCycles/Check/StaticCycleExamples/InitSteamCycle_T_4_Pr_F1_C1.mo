...
equation
  ...
  connect(mixer3_1.outlet, feedwatertank.tap_in) annotation (Line(
      points={{-20.5,-41},{-16,-41},{-16,-51.6}},
      color={0,131,169},
      smooth=Smooth.None));
  connect(valve_IP.outlet, mixer3_1.inlet_2) annotation (Line(
      points={{3,-16.4},{3,-32},{-24,-32},{-24,-36.5},{-25,-36.5}},
      color={0,131,169},
      smooth=Smooth.None));
  ...
  connect(triple8.steamSignal, mixer3_1.outlet) annotation (Line(
      points={{-6.375,-44.0714},{-14,-44.0714},{-14,-41},{-20.5,-41}},
      color={0,131,169},
      smooth=Smooth.None));
  ...
  connect(triple11.steamSignal, feedwatertank.cond_in) annotation (Line(
      points={{5.625,-52.0714},{2,-52.0714},{2,-52},{-2,-52},{-2,-60},{-5.6,-60}},
      color={0,131,169},
      smooth=Smooth.None));
