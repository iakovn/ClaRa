...
//parameter Real efficiency_Turb_LP2=1 "Efficiency of turbine" annotation(Dialog(tab="Turbines"));
  ...
  ClaRa.StaticCycles.Mixer1 mixer annotation (Placement(transformation(extent={{960,-180},{940,-168}})));
  ...
  ClaRa.StaticCycles.Mixer1 mixer1 annotation (Placement(transformation(extent={{723,-180},{706,-168}})));
  ...
  ClaRa.StaticCycles.Mixer3 mixer3_1
    annotation (Placement(transformation(extent={{730,-98},{750,-110}})));
  ...
  ClaRa.StaticCycles.Mixer1 mixer3 annotation (Placement(transformation(extent={{406,-182},{386,-162}})));
  ClaRa.StaticCycles.Mixer3 mixer3_2
    annotation (Placement(transformation(extent={{210,-112},{230,-132}})));
  ...
  ClaRa.StaticCycles.Preheater1 preheater_IP1(
    ...
    p_tap=preheater_IP1_p_tap - valve_IP1_dp_nominal) annotation (Placement(transformation(
        extent={{-20,20},{20,-20}},
        rotation=90,
        origin={-90,4})));
...
equation
  connect(feedwatertank.cond_out, pump_fw.inlet) annotation (Line(
      points={{267,-170.667},{174,-170.667},{174,-170},{78.8,-170}},
      color={0,131,169},
      smooth=Smooth.None));
  ...
  connect(mixer1.inlet_2, pump_preheater_LP2.outlet) annotation (Line(
      points={{714.5,-179},{715.111,-179},{715.111,-228},{731.2,-228}},
      color={0,131,169},
      smooth=Smooth.None));
  ...
  connect(Pump_preheater_LP3.outlet, mixer.inlet_2) annotation (Line(
      points={{938.8,-228},{950,-228},{950,-179}},
      color={0,131,169},
      smooth=Smooth.None));
  ...
  connect(pump_preheater_IP3.outlet, mixer3.inlet_2) annotation (Line(
      points={{407.2,-230},{396,-230},{396,-180.333}},
      color={0,131,169},
      smooth=Smooth.None));
  connect(feedwatertank.tap_in, mixer3_2.outlet) annotation (Line(
      points={{293,-151.067},{293,-128.667},{229,-128.667}},
      color={0,131,169},
      smooth=Smooth.None));
  connect(mixer3_2.inlet_2, valve_IP2.outlet) annotation (Line(
      points={{220,-113.667},{220,-44},{326,-44},{326,20.2}},
      color={0,131,169},
      smooth=Smooth.None));
  ...
  connect(mixer4_1.outlet, preheater_HP_IP1.tap_in) annotation (Line(
      points={{-158.667,-70},{-158.667,-124},{-110.8,-124}},
      color={0,131,169},
      smooth=Smooth.None));
  connect(valve5.outlet, mixer3_2.inlet_1) annotation (Line(
      points={{-19.2,-124},{92,-124},{92,-128.667},{211,-128.667}},
      color={0,131,169},
      smooth=Smooth.None));
  ...
  connect(mixer4_1.inlet_2, valve4.outlet) annotation (Line(
      points={{-152.667,-61},{-144,-61},{-144,-62},{-140.8,-62}},
      color={0,131,169},
      smooth=Smooth.None));
  ...
  connect(valve_dp_nom3_1.inlet, mixer3.outlet) annotation (Line(
      points={{364.8,-169},{373.2,-169},{373.2,-165.333},{387,-165.333}},
      color={0,131,169},
      smooth=Smooth.None));
  connect(valve_dp_nom3_1.outlet, feedwatertank.cond_in) annotation (Line(
      points={{343.2,-169},{331.8,-169},{331.8,-170.667},{319,-170.667}},
      color={0,131,169},
      smooth=Smooth.None));
