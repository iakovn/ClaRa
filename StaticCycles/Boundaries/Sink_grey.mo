...
model Sink_grey "A boundary for power connections"
  ...
  ClaRa_Dev.StaticCycles.Fundamentals.PowerSignal_A inlet(s="") annotation (Placement(transformation(extent={{-100,-10},{-92,10}}), iconTransformation(extent={{-100,-10},{-92,10}})));
