...
//___________________________________________________________________________//
  ...
  final parameter ClaRa.Basics.Units.MassFlowRate m_flow_2=m_flow_1-m_flow_3
  ...
  parameter ClaRa.Basics.Units.Pressure p_nom=1e5 "Mixer pressure";

  Fundamentals.SteamSignal_blue inlet(p=p_nom) annotation (Placement(transformation(
          extent={{-56,10},{-36,30}}), iconTransformation(extent={{-50,10},{-44,30}})));
  Fundamentals.SteamSignal_green outlet_1(m_flow=m_flow_2, h=h1, p=p_nom) annotation (Placement(transformation(extent={{36,10},{56,30}}), iconTransformation(extent={{44,10},{50,30}})));
  Fundamentals.SteamSignal_yellow outlet_2(h=h1, p=p_nom) annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
