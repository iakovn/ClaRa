...
//  Modelica.SIunits.Volume Vl "Liquid volume in the tank";
//   Modelica.SIunits.Length absLevel "Absolute filling level";
...
public
  ClaRa.Basics.Interfaces.FluidPortOut outlet(Medium=medium) "Outlet port"
    annotation (Placement(transformation(extent={{-108,-30},{-88,-10}}),
        iconTransformation(extent={{-270,-110},{-250,-90}})));
  ClaRa.Basics.Interfaces.FluidPortIn heatingSteam(Medium=medium) "Heating steam inlet"
    annotation (Placement(transformation(extent={{-210,70},{-190,90}}),
        iconTransformation(extent={{-210,70},{-190,90}})));
  ClaRa.Basics.Interfaces.FluidPortIn condensate(Medium=medium) "Main condensate inlet"
    annotation (Placement(transformation(extent={{92,-30},{112,-10}}),
        iconTransformation(extent={{190,50},{210,70}})));
public
...
protected
  ClaRa.Basics.Interfaces.EyeIn eye_int
    annotation (Placement(transformation(extent={{-61,-31},{-59,-29}})));
equation
  connect(eye_int, eye) annotation (Line(
      points={{-60,-30},{-60,-100},{-202,-100}},
      color={190,190,190},
      smooth=Smooth.None));
