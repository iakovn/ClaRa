...
record Summary
  ...
  Units.Power P_term "Excitation power";
  Units.Power P_gap "Air gap electric power";
  Units.Power P_mech "Mechanic power";
  Units.Power P_loss "Heat loss";
  Units.RPM rpm "Shaft rotational speed";
  Units.RPM rpm_sync "Synchronous rotational speed";
  Real slip "Slip (rpm_sync-rpm)/rpm_sync";
  Units.Torque tau_rotor "Electric rotor torque";
  Units.Torque tau_mech "Mechanic shaft torque";
  Units.Efficiency eta "Total electric efficiency";
  Units.ElectricVoltage U_term "Terminal volage";
  Units.ElectricCurrent I_rotor "Rotor current";
end Summary;
