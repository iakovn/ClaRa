...
public
  ...
  replaceable model RadiationTimeConstant =
    ...
    constrainedby ClaRa.Components.Furnace.GeneralTransportPhenomena.ThermalCapacities.PartialThermalCapacity
                                                                                            annotation (Dialog(group="Heat transfer correlations"), choicesAllMatching=true);
  //________________________/ replaceable models for burning time and migration speed \_________________________
...
//coal_diffusity = abs(Stepsmoother(-0.001,0.001,t_dwell_flueGas-burning_time.t) * (1.0 - t_dwell_flueGas/burning_time.t));
