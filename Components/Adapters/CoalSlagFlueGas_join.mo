...
//___________________________________________________________________________//
 ...
 //__________________________/ Media definintions \______________________________________________
  ...
  ClaRa.Basics.Interfaces.Coal_inlet coal_inlet(coalType=coalType)
  ...
  Basics.Interfaces.CoalSlagFlueGas_outlet      coalSlagFlueGas_outlet(
