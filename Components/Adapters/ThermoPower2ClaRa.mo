...
//___________________________________________________________________________//
  replaceable package ThermoPowerMedium = Modelica.Media.Water.WaterIF97_ph "Medium model of the ThermoPower part"
  ...
  ClaRa.Components.Adapters.Fundamentals.FlangeA
          flangeA(redeclare package Medium=ThermoPowerMedium)
