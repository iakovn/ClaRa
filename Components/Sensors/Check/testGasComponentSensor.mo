...
//___________________________________________________________________________//
  ...
  Basics.ControlVolumes.GasVolumes.VolumeGas_L2 flueGasCell annotation (Placement(transformation(extent={{50,-30},{70,-10}})));
  ...
  Basics.ControlVolumes.GasVolumes.VolumeGas_L2 flueGasCell1 annotation (Placement(transformation(extent={{50,-96},{70,-76}})));
