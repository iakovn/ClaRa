...
model TestPumpModel_NonDesignOperation_L1Pump "Non Design Operation: zero mass flow through valve"
...
//___________________________________________________________________________//
  ...
  PumpVLE_L1_affinity pump_3(
    ...
    rpm_fixed=4600,
    Delta_p_max=2e5,
    Tau_stab=1e-2) annotation (Placement(transformation(extent={{-42,-152},{-22,-132}})));
...
equation
  ...
  connect(pump_3.outlet, valveVLE_L1_1.inlet) annotation (Line(
      ...
      thickness=0.5,
      smooth=Smooth.None));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-160,-160},{160,40}}),
                      graphics={Text(
...
"),                    Text(
    ...
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,
            100}}), graphics));
end TestPumpModel_NonDesignOperation_L1Pump;
