...
public
  ...
  Modelica.Blocks.Sources.BooleanExpression I_activation(y=time_lag_I_activation.y
      ...
      Placement(transformation(
        ...
        rotation=0,
        origin={-67.5,20.25})));
  FirstOrderClaRa smoothPIDInput(Tau=Tau_in)
    annotation (Placement(transformation(extent={{-110,-3.5},{-104,3}})));
  FirstOrderClaRa smoothPIDOutput(Tau=Tau_out)
  ...
  FirstOrderClaRa smoothPIDOutput1(Tau=Tau_add)
