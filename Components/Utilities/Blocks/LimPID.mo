...
public
  ...
  ClaRa.Components.Utilities.Blocks.Integrator I(
    ...
    initType= if initType == InitPID.SteadyState    then Modelica.Blocks.Types.Init.SteadyState
                       ...
                       with_I annotation (Placement(transformation(extent={{-30,-92},{-10,-72}}, rotation=0)));
  ClaRa.Components.Utilities.Blocks.DerivativeClaRa D_approx(
    ...
    initType=if initType == InitPID.SteadyState or initType == InitPID.InitialOutput
         then Modelica.Blocks.Types.Init.SteadyState else if initType == InitPID.InitialState
         then Modelica.Blocks.Types.Init.InitialState else Modelica.Blocks.Types.Init.NoInit,
    Tau=Nd) if with_D annotation (Placement(transformation(extent={{-28,50},{-8,70}}, rotation=0)));
...
public
  ...
  ClaRa.Components.Utilities.Blocks.FirstOrderClaRa smoothPIDOutput1(Tau=
    ...
    annotation (Placement(transformation(extent={{120,57.5},{140,78}})));
