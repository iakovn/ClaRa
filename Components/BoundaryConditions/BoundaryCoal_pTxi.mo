...
model BoundaryCoal_pTxi "A source defining pressure, temperature and composition"
...
public
  ClaRa.Basics.Interfaces.Coal_inlet coal_a(final coalType=coalType)
