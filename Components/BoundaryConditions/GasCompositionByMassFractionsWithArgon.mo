...
model GasCompositionByMassFractionsWithArgon "set (flue) gas composition graphically for flue gas with argon"
...
//___________________________________________________________________________//
  ...
  parameter Real xi_NH3 "mass fraction of ammonia";
...
GasCompositionByMassFractions Model</a><br>
                                   ...
                                   Diagram(graphics),
              Icon(graphics));
end GasCompositionByMassFractionsWithArgon;
