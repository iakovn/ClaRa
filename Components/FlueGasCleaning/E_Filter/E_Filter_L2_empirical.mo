...
model E_Filter_L2_empirical "Model for an electrical dust filter based on the Deutsch-Equation for the separation rate with empirical numbers for the partical migration speed"
