...
model E_Filter_L1_ideal "Model for an idealised electrical dust filter"
...
inner parameter TILMedia.GasTypes.BaseGas               medium = simCenter.flueGasModel "Medium to be used in filter"
...
parameter Real separationRate(max = 0.99995) = 0.9995;
...
Summary summary(outline(
    ...
    p=outlet.p,
    h=flueGasOutlet.h,
    H_flow = -flueGasOutlet.h*outlet.m_flow));
