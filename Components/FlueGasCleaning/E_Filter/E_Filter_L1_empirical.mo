...
model E_Filter_L1_empirical "Model for an electrical dust filter based on the Deutsch-Equation for the separation rate with empirical numbers for the partical migration speed"
...
inner parameter ClaRa.Basics.Choices.Init initType=ClaRa.Basics.Choices.Init.noInit "Type of initialisation"
  ...
  parameter Modelica.SIunits.Velocity w_m= 0.15 "Migration speed of dust particles in the E-field";
  parameter ClaRa.Basics.Units.Area A_el= 100 "Collector area of E-Filter";
...
protected
   ...
   ClaRa.Basics.Units.MassFlowRate m_flow_dust_out;
   ClaRa.Basics.Units.Power powerConsumption;
