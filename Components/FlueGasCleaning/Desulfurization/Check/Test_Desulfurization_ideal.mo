...
model Test_Desulfurization_ideal
  ...
  inner SimCenter simCenter(contributeToCycleSummary=true, redeclare TILMedia.GasTypes.FlueGasTILMedia flueGasModel) annotation (Placement(transformation(extent={{68,68},{88,88}})));
equation
