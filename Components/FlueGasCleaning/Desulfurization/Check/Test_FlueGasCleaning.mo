...
model Regression
 ...
 Modelica.Blocks.Interfaces.RealInput deNOx_NH3_port_m_flow_out "Outlet mass flow of deNOx NH3 port";
 Modelica.Blocks.Interfaces.RealInput deNOx_NH3_port_T_out "Outlet temperature of deNOx NH3 port";
 ...
 Components.Utilities.Blocks.Integrator integrator_deNOx_NH3_port_m_flow_out(u=deNOx_NH3_port_m_flow_out) annotation (Placement(transformation(extent={{-80,-66},{-60,-46}})));
 Components.Utilities.Blocks.Integrator integrator_deNOx_NH3_port_T_out(u=deNOx_NH3_port_T_out) annotation (Placement(transformation(extent={{-80,-98},{-60,-78}})));
 ...
 Components.Utilities.Blocks.Integrator integrator_pipeFlowGas_L4_Simple_p_out(u=pipeFlowGas_L4_Simple_p_out) annotation (Placement(transformation(extent={{-18,-34},{2,-14}})));
  ...
  Denitrification.Denitrification_L1
    ...
    redeclare model PressureLoss =
        Basics.ControlVolumes.Fundamentals.PressureLoss.Generic_PL.LinearPressureLoss_L2 (                   Delta_p_nom=100))
  ...
  Modelica.Blocks.Sources.Ramp Temperature1(
    ...
    offset=273.15 + 250)
        ...
        rotation=0,
        origin={-70,-188})));
  Denitrification.Denitrification_L1_NH3port deNOx_NH3_port(redeclare model HeatTransfer =
        ClaRa.Basics.ControlVolumes.Fundamentals.HeatTransport.Generic_HT.Adiabat_L2,                                                                                    redeclare model PressureLoss =
        Basics.ControlVolumes.Fundamentals.PressureLoss.Generic_PL.LinearPressureLoss_L2 (                   Delta_p_nom=100)) annotation (Placement(transformation(extent={{4,-184},{24,-164}})));
  ...
  E_Filter.E_Filter_L2_simple                                  e_Filter_dynamic(separationRate=0.9995, xi_start={0.0,0,0.73,0,0.065,0.036,0,0.13,0.0},
    redeclare model PressureLoss =
        Basics.ControlVolumes.Fundamentals.PressureLoss.Generic_PL.QuadraticNominalPoint_L2 (                Delta_p_nom=100))              annotation (Placement(transformation(extent={{216,12},{236,32}})));
  ...
  VolumesValvesFittings.Pipes.PipeFlowGas_L4_Simple pipeFlowGas_L4_Simple(
    ...
    redeclare model HeatTransfer =
        Basics.ControlVolumes.Fundamentals.HeatTransport.Generic_HT.Constant_L4 (                           alpha_nom=10),
    length=1,
    diameter_i=0.5,
