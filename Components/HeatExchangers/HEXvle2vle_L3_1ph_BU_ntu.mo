...
model HEXvle2vle_L3_1ph_BU_ntu
  ...
  model Outline
    ...
    input Basics.Units.TemperatureDifference Delta_T_in
      "Fluid temperature at inlet T_1_in - T_2_in";
    input Basics.Units.TemperatureDifference Delta_T_out
  ...
  parameter Basics.Units.Length z_out_shell=0.1 "Outlet position from bottom"
    annotation (Dialog(tab="Shell Side", group="Geometry"));
  parameter Basics.Choices.GeometryOrientation flowOrientation=ClaRa.Basics.Choices.GeometryOrientation.vertical
    "Flow orientation at shell side"   annotation(Dialog(tab="Shell Side", group="Geometry"));

  //________________________________ Shell nominal parameter _____________________________________//
  parameter Basics.Units.MassFlowRate m_nom_shell=40
    "Nominal mass flow on shell side"
    annotation (Dialog(tab="Shell Side", group="Nominal Values"));
  parameter Basics.Units.Pressure p_nom_shell=35e5
    "Nominal pressure on shell side"
    annotation (Dialog(tab="Shell Side", group="Nominal Values"));
  parameter Basics.Units.EnthalpyMassSpecific h_nom_shell=3500e3
  ...
  parameter Basics.Units.EnthalpyMassSpecific h_start_shell=100e3
  ...
  parameter Basics.Units.Pressure p_start_shell=1e5
    "Start value of sytsem pressure"
    annotation (Dialog(tab="Shell Side", group="Initialisation"));
  ...
  parameter Basics.Units.Length diameter_i=0.019
    "Inner diameter of horizontal tubes"                                                 annotation (Dialog(tab="Tubes", group="Tubes Geometry",groupImage="modelica://ClaRa/figures/ParameterDialog/HEX_ParameterDialogTubes.png"));
  parameter Basics.Units.Length diameter_o=0.027
    "Outer diameter of horizontal tubes"                                                 annotation (Dialog(tab="Tubes", group="Tubes Geometry"));
  ...
  parameter Basics.Units.Length Delta_z_par=2*diameter_o
    "Distance between tubes parallel to flow direction"                                                         annotation (Dialog(tab="Tubes", group="Tubes Geometry"));
  parameter Basics.Units.Length Delta_z_ort=2*diameter_o
    "Distance between tubes orthogonal to flow direction"                                                         annotation (Dialog(tab="Tubes", group="Tubes Geometry"));
  ...
  parameter Basics.Units.MassFlowRate m_nom_tubes=400
    "Nominal mass flow on side 2"
    annotation (Dialog(tab="Tubes", group="Nominal Values"));
  parameter Basics.Units.Pressure p_nom_tubes=400e5
    "Nominal pressure on side 2"
    annotation (Dialog(tab="Tubes", group="Nominal Values"));
  ...
  parameter Basics.Choices.Init initTypeShell=ClaRa.Basics.Choices.Init.noInit
    ...
    annotation (Dialog(tab="Shell Side", group="Initialisation"));
  parameter Basics.Units.EnthalpyMassSpecific h_start_tubes=100e3
    "Start value of sytsem specific enthalpy"
  ...
  parameter Basics.Units.Mass mass_struc=25000
  ...
  parameter Basics.Choices.Init initWall=ClaRa.Basics.Choices.Init.noInit
    "|Initialisation option for wall"                                                                          annotation (Dialog(tab="Tube Wall", group="Initialisation"));
  parameter Basics.Units.Temperature T_w_i_start=293.15
    "Initial wall temperature at inner side"                                                        annotation (Dialog(tab="Tube Wall", group="Initialisation"));
  parameter Basics.Units.Temperature T_w_o_start=293.15
    "Initial wall temperature at shell side"                                                        annotation (Dialog(tab="Tube Wall", group="Initialisation"));
