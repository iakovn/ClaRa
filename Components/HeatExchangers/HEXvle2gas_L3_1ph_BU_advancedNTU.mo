...
model HEXvle2gas_L3_1ph_BU_advancedNTU "VLE 2 gas | L3 | 1 phase on each side | Block shape | U-type | NTU ansatz"
...
public
  ...
  Basics.ControlVolumes.SolidVolumes.NTU_L2 wall(
    length=length,
    ...
    stateLocation=2) annotation (Placement(transformation(extent={{20,20},{40,40}})));
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,
          ...
          textString="NTU")}),Diagram(coordinateSystem(preserveAspectRatio=false,
                   extent={{-100,-100},{100,100}}),
                                      graphics));
end HEXvle2gas_L3_1ph_BU_advancedNTU;
