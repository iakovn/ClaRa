...
type Init = enumeration(
    ...
    steadyDensityPressure "Steady density/mass and pressure")
  "The initialisation of a thermal control volume"                                                             annotation (Icon(graphics={Line(points={{-100,100},{100,-100}}, color={255,0,0}), Line(points={{100,100},{-100,-100}}, color={255,0,0})}));
