...
record IComGas_L3
  ...
  input SI.MassFraction xi_in[N_inlet,mediumModel.nc - 1] "|Inlet||Inlet medium composition";
  input SI.MassFraction xi_out[N_outlet,mediumModel.nc - 1] "|Outlet||Outlet medium composition";
end IComGas_L3;
