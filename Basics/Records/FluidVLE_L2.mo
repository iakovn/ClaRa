...
model FluidVLE_L2 "A record for basic VLE fluid data from L2-type models"
  ...
  input Units.Temperature T_sat if showExpertSummary
  ...
  input Units.EnthalpyMassSpecific h_bub if showExpertSummary
    "Bubble specific enthalpy"                                                            annotation(Dialog(show));
  input Units.EnthalpyMassSpecific h_dew if showExpertSummary
    "Dew specific enthalpy"                                                           annotation(Dialog(show));
  input Units.EntropyMassSpecific s if showExpertSummary
