...
//____Variables for system description__________________________________________________
  TILMedia.GasObjectFunctions.GasPointer fluidPointer_bulk
    "Pointer to bulk gas object"                                                            annotation(Dialog(tab="System"));
  replaceable parameter TILMedia.GasTypes.FlueGasTILMedia mediumModel
    "Used medium model"                                                                   annotation(Dialog(tab="System"));

//____Inlet_____________________________________________________________________________
  TILMedia.GasObjectFunctions.GasPointer fluidPointer_in
    "Pointer to inlet gas object"                                                          annotation(Dialog(tab="Inlet"));
...
//____Outlet____________________________________________________________________________
  TILMedia.GasObjectFunctions.GasPointer fluidPointer_out
    "Pointer to outlet gas object"                                                           annotation(Dialog(tab="Outlet"));
