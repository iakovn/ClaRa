...
//____Variables for system description__________________________________________________
  input TILMedia.GasObjectFunctions.GasPointer fluidPointer_bulk "Pointer to bulk gas object"
...
//____Inlet_____________________________________________________________________________
  input TILMedia.GasObjectFunctions.GasPointer fluidPointer_in "Pointer to inlet gas object"
                                                                                           annotation(Dialog(tab="Inlet"));
  input SI.VolumeFlowRate V_flow_in "Inlet  volume flow" annotation(Dialog(tab="Inlet"));
...
//____Outlet____________________________________________________________________________
  input TILMedia.GasObjectFunctions.GasPointer fluidPointer_out "Pointer to outlet gas object"
                                                                                             annotation(Dialog(tab="Outlet"));
  input SI.VolumeFlowRate V_flow_out "Outlet volume flow" annotation(Dialog(tab="Outlet"));
