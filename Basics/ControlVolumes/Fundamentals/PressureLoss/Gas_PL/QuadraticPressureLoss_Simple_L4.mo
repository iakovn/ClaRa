...
model QuadraticPressureLoss_Simple_L4 "Gas || Quadratic PL with const. PL coeff"
...
//___________________________________________________________________________//
  ...
  parameter ClaRa.Basics.Units.DensityMassSpecific rho_nom = TILMedia.GasFunctions.density_phxi(iCom.mediumModel,iCom.p_nom,iCom.h_nom,iCom.xi_nom);
...
//  outer ClaRa.Components.ComponentBaseClasses.Fundamentals2.PipeGeometry geo;
  ...
  parameter Modelica.SIunits.Pressure Delta_p_smooth=iCom.Delta_p_nom/100 "|Small Mass Flows|For pressure losses below this value the square root of the quadratic pressure loss model is regularised";
