...
partial model PressureLoss_L4 "Gas || PL Base Class"
  ...
  final parameter Basics.Units.Length Delta_x_FM[iCom.N_cv + 1]=geo.Delta_x_FM
    "flowModel grid";

  final parameter Basics.Units.MassFlowRate m_flow_nom=iCom.m_flow_nom
    "Nominal mass flow rate";

  final parameter Basics.Units.PressureDifference Delta_p_nom=iCom.Delta_p_nom
    "Nominal pressure loss wrt. all parallel tubes";
