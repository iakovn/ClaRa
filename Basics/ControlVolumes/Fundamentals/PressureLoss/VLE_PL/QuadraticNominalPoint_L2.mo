...
equation
  rho_in=TILMedia.VLEFluidObjectFunctions.density_phxi(iCom.p_in,iCom.h_in, iCom.xi_in,iCom.fluidPointer_in);
...
//                               iCom.m_flow_nom/Delta_p_nom*Delta_p);
  iCom.m_flow_in = homotopy(geo.A_cross*sqrt(2*rho_in/zeta)*ClaRa.Basics.Functions.ThermoRoot(Delta_p,Delta_p_smooth),
                              iCom.m_flow_nom/Delta_p_nom*Delta_p);
