...
public
  FluidDissipation.PressureLoss.General.dp_pressureLossCoefficient_IN_con inCon(A_cross=geo.A_cross, dp_smooth=Delta_p_smooth) annotation (Placement(transformation(extent={{-60,-80},{-40,-60}})));
  FluidDissipation.PressureLoss.General.dp_pressureLossCoefficient_IN_var inVar(zeta_TOT=zeta_TOT, rho=if useHomotopy then homotopy(Stepsmoother(
        10,
        -10,
...
equation
  ...
  iCom.m_flow_in = FluidDissipation.PressureLoss.General.dp_pressureLossCoefficient_MFLOW(
    inCon,
    inVar,
    Delta_p);
