...
model CharLineHTC_AMTD "All Geo || HTC || Characteristic Line || AMTD"
...
//     ClaRa.Basics.ControlVolumes.Fundamentals.HeatTransport.HeatTransferGas;
  ...
  parameter Modelica.SIunits.CoefficientOfHeatTransfer kc_nom = 10 "Constant heat transfer coefficient"
...
protected
  Modelica.Blocks.Tables.CombiTable1Ds kc_corr(table=PL_kc)
    annotation (Placement(transformation(extent={{-30,-90},{-10,-70}})));
equation

//heat.Q_flow = kc*iCom.A_heat* (2*ClaRa.Basics.Functions.Stepsmoother(1e-3, -1e-3, heat.T-T_mean)-1)*DT_mean;
  heat.Q_flow = kc*iCom.A_heat*ClaRa.Basics.Functions.Stepsmoother(100,-100,(DT_wi)*(DT_wo))*(DT_wi+DT_wo)/2;
