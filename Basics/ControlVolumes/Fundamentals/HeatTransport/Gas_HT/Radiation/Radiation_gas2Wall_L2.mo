...
//___________________________________________________________________________//
  ...
  outer ClaRa.Basics.ControlVolumes.Fundamentals.Geometry.HollowBlock
    geo;

equation
  //Nach VDI Waermeatlas fuer eine ein Gasvolumen umschliessende Wand
  heat.Q_flow = geo.A_heat_CF[heatSurfaceAlloc]* CF_fouling *Modelica.Constants.sigma*emissivity_wall/(
    absorbance_flame + emissivity_wall - absorbance_flame*emissivity_wall)*(
    absorbance_flame*heat.T^4 - emissivity_flame*iCom.T_out^4);
