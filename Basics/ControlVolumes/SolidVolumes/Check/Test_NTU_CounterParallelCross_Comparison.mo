...
model Test_NTU_CounterParallelCross_Comparison
  ...
  parameter Units.Temperature T_o_in=450 "Temperature of cold side";
  parameter Units.Temperature T_i_in=200 "Temperature of hot side";
  parameter Units.MassFlowRate m_flow_o=1 "Mass flow of cold side";
  parameter Units.MassFlowRate m_flow_i=0.2 "Mass flow of hot side";
  ...
  annotation (
    Diagram(coordinateSystem(extent={{-100,-100},{100,100}}, preserveAspectRatio=true), graphics={Text(
          ...
          fontSize=26,
          textString="Tested! // 31. Jan 2013, AR"),Text(
          extent={{-80,20},{-40,0}},
          lineColor={0,0,0},
          textStyle={TextStyle.Bold},
          fontSize=20,
          textString="Counter flow"),Text(
          extent={{-20,20},{20,0}},
          lineColor={0,0,0},
          fontSize=20,
          textStyle={TextStyle.Bold},
          textString="Parallel flow"),Text(
          extent={{40,20},{80,0}},
          lineColor={0,0,0},
          fontSize=20,
          textStyle={TextStyle.Bold},
