...
ECom eCom;
  ...
  Units.HeatFlowRate Q_flow[3] "Heat flow rate of zones |1|2|3|";
  Units.HeatFlowRate Q_flow_tot "Total heat flow rate";
  ...
  ClaRa.Basics.Units.Temperature T_i[6] "Temperatures (i/o) of outer flow zones |1|2|3|";
  ClaRa.Basics.Units.Temperature T_o[6] "Temperatures (i/o) of outer flow zones |1|2|3|";

  ClaRa.Basics.Units.Temperature T_i_sat "Inner side saturation temperature";
  ClaRa.Basics.Units.Temperature T_o_sat "Outer side saturation temperature";
  Real yps[3] "Area fractions";
  Real effectiveness[3] "effectiveness in zones |1|2|3|";
...
extends ClaRa.Basics.Icons.RecordIcon;
  ...
  Units.EnthalpyMassSpecific h_i[6] "Specific enthalpies (i/o) of inner flow zones |1|2|3|";
  Units.EnthalpyMassSpecific h_o[6] "Specific enthalpies (i/o) of outer flow zones |1|2|3|";
end ECom;
