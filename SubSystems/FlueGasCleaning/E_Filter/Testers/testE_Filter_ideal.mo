...
equation
  ...
  connect(Temperature.y, idealGasFlowSource_XRG.T)
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(e_Filter_01_1.flueGas_a, idealGasFlowSource_XRG.gas_a) annotation (
      Line(
      points={{-10,0},{-20,0}},
      color={84,58,36},
      smooth=Smooth.None));
  connect(idealGasPressureSink_XRG.gas_a, e_Filter_01_1.flueGas_b) annotation (
      Line(
