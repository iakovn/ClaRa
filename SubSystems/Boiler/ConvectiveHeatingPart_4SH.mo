...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  parameter Modelica.SIunits.Pressure p_startSH4_out=300e5 "Start value of pressure at SH4 outlet"
                                            annotation(Dialog(tab= "Superheater 4", group="Initialisation"));
  parameter Basics.Choices.Init      initTypeSH4=ClaRa.Basics.Choices.Init.noInit "Type of initialisation of SH4"
                                    annotation(Dialog(tab= "Superheater 4", group="Initialisation"));
...
public
  ...
  ClaRa.Components.VolumesValvesFittings.Pipes.PipeFlow_L4_Simple superheater4(
    N_cv=N_ax,
    medium=medium,
    useHomotopy=useHomotopy,
    m_flow_nom=m_flow_nom + m_flow_nomSpray1 + m_flow_nomSpray2,
...
equation
  connect(sprayInjector1.SprayInlet, spray1)
                                            annotation (Line(
      points={{16,-122.6},{60,-122.6},{60,-122},{104,-122}},
      color={191,56,33},
      thickness=0.5,
      smooth=Smooth.None));
  ...
  connect(sprayInjector1.outlet1, SH2_InletHeader.inlet)
                                                        annotation (Line(
      points={{-3.2,-107},{-3.2,-102.75},{-4,-102.75},{-4,-98.5},{-4,-90},{-4,-90}},
      color={191,56,33},
      thickness=0.5,
      smooth=Smooth.None));
  ...
  connect(sprayInjector2.SprayInlet,spray2)  annotation (Line(
      points={{14,99.4},{56,99.4},{56,102},{98,102}},
      color={191,56,33},
      thickness=0.5,
      smooth=Smooth.None));
  connect(sprayInjector2.opening,opening2)  annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(sprayInjector2.MainInlet, SH3_OutletHeader.outlet) annotation (Line(
      points={{-5.2,89},{-5.2,74},{-4,74}},
      color={191,56,33},
      thickness=0.5,
      smooth=Smooth.None));
  ...
  connect(SH4_outWall.innerPhase, SH4_OutletHeader.heat) annotation (Line(
      ...
      color={191,0,0},
      smooth=Smooth.None));
  connect(SH4_InletHeader.inlet, sprayInjector2.outlet1) annotation (Line(
      points={{-2,144},{-5.2,144},{-5.2,115}},
      color={191,56,33},
      thickness=0.5,
      smooth=Smooth.None));
