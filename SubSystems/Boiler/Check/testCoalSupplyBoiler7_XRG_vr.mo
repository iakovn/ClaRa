...
//___________________________________________________________________________//
  ...
  SteamGenerator_L3_vr                         steamGenerator_1_XRG(
...
public
  ...
  Components.VolumesValvesFittings.Fittings.Split_L2_Y split_IET3_1
    annotation (Placement(transformation(extent={{114,-102},{134,-90}})));
...
equation
  ...
  connect(IPTurbine.outlet,split_IET3_1. inlet) annotation (Line(
      points={{100,-76},{112,-76},{112,-96},{114,-96}},
      color={0,131,169},
      thickness=0.5,
      smooth=Smooth.None));
  ...
  connect(split_IET3_1.outlet1, LPTurbine.outlet) annotation (Line(
      points={{134,-96},{136,-96},{136,-94},{138,-94},{138,-76}},
      color={0,131,169},
