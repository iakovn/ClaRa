...
//___________________________________________________________________________//
  ...
  Components.Control.PredictorModels_3508.CoalSupplyBoiler_01_XRG
                                                    Model_boiler(p_LS_nom=
        24000000)
  ...
  Components.Utilities.Blocks.LimPID PID(
    y_max=1,
    Tau_d=1000,
    ...
    k=2.5) annotation (Placement(transformation(extent={{-98,80},{-78,100}})));
  ...
  ClaRa.SubSystems.Boiler.SteamGenerator_L1
                       SG1(p_LS_nom=24000000)
    annotation (Placement(transformation(extent={{-6,-64},{20,-28}})));
...
protected
  Basics.Interfaces.SteamSignal      mediumData_b
...
public
  ...
  Components.BoundaryConditions.BoundaryVLE_phxi      pressureSink2(variable_p=false, p_const(displayUnit="Pa") = 3000) annotation (Placement(transformation(extent={{188,-220},{170,-200}})));
  ...
  ClaRa.SubSystems.Boiler.SteamGenerator_L3    SG2(p_LS_nom=24000000)
    annotation (Placement(transformation(extent={{-8,-198},{20,-158}})));
  Components.BoundaryConditions.BoundaryVLE_hxim_flow  massFlowSource_XRG1(
    m_flow_const=419,
    h_const=500e3,
