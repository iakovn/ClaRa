...
//___________________________________________________________________________//
  ...
  ClaRa.Components.VolumesValvesFittings.Pipes.PipeFlow_L4_Simple superheater1(
    N_cv=N_ax,
    length=length_SH1,
    ...
    h_nom=linspace(
        ...
        superheater1.N_cv),
    showData=true,
    Delta_p_nom=Delta_p_nomSH1) "Comprehending the supporting tubes section"
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  parameter Modelica.SIunits.Pressure p_startSH1_out=300e5 "Start value of pressure at SH1 outlet"
                                            annotation(Dialog(tab= "Superheater 1", group="Initialisation"));
  parameter Basics.Choices.Init      initTypeSH1=ClaRa.Basics.Choices.Init.noInit "Type of initialisation of SH1"
                                    annotation(Dialog(tab= "Superheater 1", group="Initialisation"));
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  parameter Modelica.SIunits.Pressure p_startSH2_out=300e5 "Start value of pressure at SH2 outlet"
                                            annotation(Dialog(tab= "Superheater 2", group="Initialisation"));
  parameter Basics.Choices.Init      initTypeSH2=ClaRa.Basics.Choices.Init.noInit "Type of initialisation of SH2"
                                    annotation(Dialog(tab= "Superheater 2", group="Initialisation"));
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  parameter Modelica.SIunits.Pressure p_startSH3_out=300e5 "Start value of pressure at SH3 outlet"
                                            annotation(Dialog(tab= "Superheater 3", group="Initialisation"));
  parameter Basics.Choices.Init      initTypeSH3=ClaRa.Basics.Choices.Init.noInit "Type of initialisation of SH3"
                                    annotation(Dialog(tab= "Superheater 3", group="Initialisation"));
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  parameter Basics.Choices.Init      initType_Spray1=ClaRa.Basics.Choices.Init.noInit "Type of initialisation"
                             annotation(Dialog(tab="Spray Injector 1", group="Initialisation"));
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  parameter Basics.Choices.Init      initType_Spray2=ClaRa.Basics.Choices.Init.noInit "Type of initialisation"
                             annotation(Dialog(tab="Spray Injector 2", group="Initialisation"));
  ...
  ClaRa.Components.VolumesValvesFittings.Pipes.PipeFlow_L4_Simple superheater2(
    N_cv=N_ax,
    medium=medium,
    ...
    m_flow_nom=m_flow_nom + m_flow_nomSpray1,
    showData=true,
    Delta_p_nom=Delta_p_nomSH2) "Comprehending the supporting tubes section"
                                                                annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={0,-20})));
  ClaRa.Components.VolumesValvesFittings.Pipes.PipeFlow_L4_Simple superheater3(
    N_cv=N_ax,
    medium=medium,
    ...
    m_flow_nom=m_flow_nom + m_flow_nomSpray1 + m_flow_nomSpray2,
    showData=true,
    Delta_p_nom=Delta_p_nomSH3) "Comprehending the supporting tubes section"
                                                                annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={0,160})));
  ...
  ClaRa.Components.VolumesValvesFittings.Fittings.SprayInjector_L3 sprayInjector1(
    medium=medium,
    length=length_SI1,
    ...
    Delta_p_nozzle=Delta_p_nomSpray1,
  ...
  ClaRa.Components.VolumesValvesFittings.Fittings.SprayInjector_L3 sprayInjector2(
    medium=medium,
    ...
    Delta_p_nozzle=Delta_p_nomSpray2,
...
public
  Basics.Interfaces.EmptyBus      Sensors annotation (Placement(transformation(
        extent={{-20,-20},{20,20}},
        rotation=90,
...
equation
  connect(sprayInjector1.SprayInlet, spray1)
                                            annotation (Line(
      points={{16,-122.6},{60,-122.6},{60,-80},{104,-80}},
      color={191,56,33},
      thickness=0.5,
      smooth=Smooth.None));
  connect(sprayInjector2.SprayInlet, spray2) annotation (Line(
      points={{16,95.4},{58,95.4},{58,98},{100,98}},
      color={191,56,33},
      thickness=0.5,
      smooth=Smooth.None));
  ...
  connect(sprayInjector2.opening, opening2) annotation (Line(
      points={{16,87.6},{70,87.6},{70,48},{100,48}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(SH1_InletHeader.inlet, inlet) annotation (Line(
      ...
      thickness=0.5,
      smooth=Smooth.None));
  connect(sprayInjector1.outlet1, SH2_InletHeader.inlet)
                                                        annotation (Line(
      points={{-3.2,-107},{-6.12323e-016,-98},{-6.12323e-016,-54}},
      color={191,56,33},
      thickness=0.5,
      smooth=Smooth.None));
  ...
  connect(superheater3.outlet, SH3_OutletHeader.inlet) annotation (Line(
      ...
      thickness=0.5,
      smooth=Smooth.None));
  connect(SH1_OutletHeader.outlet, sprayInjector1.MainInlet)
                                                            annotation (Line(
      points={{6.12323e-016,-152},{6.12323e-016,-143},{-3.2,-143},{-3.2,-133}},
      color={191,56,33},
      thickness=0.5,
      smooth=Smooth.None));
  ...
  connect(SH1_wall.outerPhase, heatSH1)  annotation (Line(
      ...
      color={191,0,0},
      smooth=Smooth.None));
  connect(sprayInjector2.MainInlet, SH2_OutletHeader.outlet) annotation (Line(
      points={{-3.2,85},{-3.2,34.5},{6.12323e-016,34.5},{6.12323e-016,20}},
      color={191,56,33},
      thickness=0.5,
      smooth=Smooth.None));
  connect(SH3_OutletHeader.outlet, outlet) annotation (Line(
      ...
      thickness=0.5,
      smooth=Smooth.None));
  connect(SH3_InletHeader.inlet,sprayInjector2. outlet1) annotation (Line(
      points={{-6.12323e-016,126},{-6.12323e-016,118},{-3.2,118},{-3.2,111}},
      color={191,56,33},
      thickness=0.5,
      smooth=Smooth.None));
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,-250},
            {100,250}}), graphics), Icon(coordinateSystem(preserveAspectRatio=true,
          extent={{-120,-270},{120,270}}), graphics={Bitmap(extent={{-124,278},
              {128,-278}},
          imageSource=
